...
Route::prefix('admin')->name('admin.')->middleware(['auth', 'role:admin,staff', 'staff.permission'])->group(function () {
    ...
    Route::post('/customers/{customer}/address', [Admin\CustomerController::class, 'storeAddress'])->name('customers.store-address');
    ...
    Route::get('/tracking/clients', [Admin\TrackingController::class, 'clients'])->name('tracking.clients');
