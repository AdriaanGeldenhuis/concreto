...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Assign a consistent color based on driver ID
    ...
    var avatarHtml = '<div class="driver-detail-avatar" style="background:'+driverColor+';box-shadow:0 0 16px '+driverColor+';">' +
        '<div class="driver-detail-pulse" style="border-color:'+driverColor+';"></div>' + letter + '</div>';
    var icon=L.divIcon({className:'',html:avatarHtml,iconSize:[38,38],iconAnchor:[19,19],popupAnchor:[0,-25]});
    L.marker([latest.lat,latest.lng],{icon:icon}).bindPopup('<strong style="color:'+driverColor+';">'+driverName+'</strong><br>'+(latest.speed>0?latest.speed+' km/h':'Stopped')+'<br>'+latest.time).addTo(map);
