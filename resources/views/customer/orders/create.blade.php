...
@section('content')
    <div class="page-header">
        <div class="breadcrumb"><a href="{{ route('customer.orders.index') }}">Orders</a> / New Order</div>
    ...
    <form method="POST" action="{{ route('customer.orders.store') }}">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="form-group">
                    ...
                    <p class="text-small text-muted mt-1"><a href="{{ route('customer.addresses.index') }}">Add a new address</a></p>
                </div>
                <div class="form-row">
                    <div class="form-group">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <div id="product-select" data-products='@json($products)' style="display:none;"></div>
                <div id="order-items">
                    @error('items')<div class="form-error mb-2">{{ $message }}</div>@enderror
                </div>
...
<nav class="bottom-nav">
    ...
    <a href="{{ route('customer.orders.create') }}" class="active"><span class="nav-icon">&#10010;</span>New Order</a>
