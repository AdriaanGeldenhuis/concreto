...
<body style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Arial, sans-serif; color: #2c3e50; max-width: 600px; margin: 0 auto; padding: 0; background: #f5f6fa;">
    ...
    <div style="background: #fff; padding: 32px; border-left: 1px solid #e1e8ed; border-right: 1px solid #e1e8ed;">
        <h2 style="color: #27ae60; margin: 0 0 16px; font-size: 20px;">Payment Received</h2>
        <p style="margin: 0 0 20px; font-size: 15px; line-height: 1.6;">Your payment for order <strong>{{ $order->order_number }}</strong> has been confirmed.</p>
        ...
        <table style="width: 100%; border-collapse: collapse; margin: 0 0 24px;">
            ...
            <tr style="border-bottom: 1px solid #f0f3f5;">
                <td style="padding: 12px 8px; font-weight: 600; color: #7f8c8d;">Amount Paid</td>
                <td style="padding: 12px 8px; font-weight: 800; color: #27ae60; font-size: 18px;">R{{ number_format($order->total, 2) }}</td>
            </tr>
            <tr>
                <td style="padding: 12px 8px; font-weight: 600; color: #7f8c8d;">Status</td>
                <td style="padding: 12px 8px;">
                    <span style="background: rgba(39,174,96,0.12); color: #27ae60; padding: 4px 12px; border-radius: 50px; font-size: 12px; font-weight: 600;">PAID</span>
                </td>
            </tr>
        </table>

        <p style="font-size: 14px; color: #7f8c8d;">Your order is now being processed for dispatch.</p>
    </div>
